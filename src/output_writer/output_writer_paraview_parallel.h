...
public:
    //! constructor
    OutputWriterParaviewParallel(std::shared_ptr<Discretization> discretization,
...
private:
    ...
    //! gather u,v,p and t values from all ranks to rank 0 and store them in the global field variables
    void gatherData();
